...
Block format:
    ...
    **Target:** the target, and where it comes from
...
judge the P/E together with the PEG ratio and the growth category. This method sets
...
## ratio:peg
**Name:** PEG ratio
**Target:** ≤ 1 at high growth, ≤ 0.7 at average growth, ≤ 0.5 at low growth

The central valuation metric here: it ties price to growth. Earnings growth is
"a vector with direction, force and length"; the PEG makes that measurable. The
requirement gets progressively stricter as growth is lower, hence three
...
One of the three most important valuation methods here, and more
...
operating cash flow is a clear signal of real, self-sustaining growth. It is worth
calling it a red flag outright when operating cash flow is negative while net
income is positive.

## ratio:roe
**Name:** Return on equity (ROE)
**Target:** > 15%, sustained over several years

Warren Buffett's favourite ratio, and a fair description of it is the company's savings rate.
...
with a high ROE, that is a strong foundation for value creation.
...
The outcome everything else ultimately serves: growth in
...
Revenue is the turbo trigger: harder to manipulate than profit, and
...
## ratio:gross_margin
**Name:** Gross margin
**Target:** ≥ 50%, or risen in each of the last five years

Margins make competitive advantage measurable. High, stable margins signal pricing
power. This method looks for two kinds of company: those with a high gross margin,
...
Around 12% is the S&P 500 average, and what we want is companies well above
...
There is no fixed number here, but the principle is unambiguous: too much debt is a no-go
...
**Name:** Dividend yield
**Target:** not a buy criterion; above 7% is a warning

Stated plainly: never invest solely on dividend yield. The rich
...
withdrawing your savings interest every year. 90% is the level that signals
...
("moonshots"). Adding it back to earnings reveals hidden profitability — this method
...
conservative: not all R&D is hidden profit. There are three benefits: you can
...
the hard way: in 2008 it became painfully clear that revenue is not profit —
...
**Target:** not growing faster than revenue
...
inventory — software, payment networks — are the ideal
...
**Target:** ≥ 50% below the highest closing price in five years
...
Sector leaders have more recovery potential: they recover
...
The category this framework focuses on. These companies can receive a buy signal,
...
## lynch:cyclical
**Name:** Cyclical
**Target:** outside the four focus sectors

Earnings swing strongly with the economic cycle. This covers auto, construction,
commodities and industrials in mind here. Semiconductors are explicitly not
included: their earnings are volatile, but microchips are the
...
recovery story like this can work out exceptionally well, but it belongs
...
There is too little coherent earnings history to measure growth. A warning here:
...
**Name:** Focus sector
**Target:** falls within one of the four focus sectors

This method limits itself to four sectors: information technology, luxury and
...
Cyclicals, turnarounds and financial institutions sit outside the focus;
low-growth companies only with an explicit warning.

## condition:market_cap
**Name:** Market capitalisation
**Target:** at least $10 billion
...
## condition:drawdown
**Name:** Decline from the 5-year high
**Target:** at least 50% below the highest closing price in five years

The core signal. Falls of 50 to 70% in quality companies are rare without
a structural problem, and that is exactly where the statistical edge lies.
Adjustable, with a floor of 35%.

## condition:peg
**Name:** PEG ratio
**Target:** below the growth category's threshold, realised or expected
...
**Target:** ≤ 30, or ≤ 20 after adjusting for R&D
...
**Target:** ROE > 15% and ROA > 10%, over several years
...
**Target:** free cash flow positive and operating cash flow ≥ 70% of net income
...
Too much debt is a no-go criterion here. For banks and insurers this
...
Demand or supply, not both at once. That is the difference
...
Be wary of companies that buy growth rather than earn it.
...
This is deliberately in the first person: if *you* can no longer tell
