 ...
 * or structural.
 */
function pegSentences(condition: ConditionResult, lang: Lang): string[] {
...
function buildOne(input: ExplainInput, lang: Lang): string {
  ...
  if (drawdown.value != null) {
    ...
    parts.push(`${base}${waterfall}${conviction}`);
  }
